...
describe("agent local JWT", () => {
  const secretEnv = "ZEPHYR_AGENT_JWT_SECRET";
  const ttlEnv = "ZEPHYR_AGENT_JWT_TTL_SECONDS";
  const issuerEnv = "ZEPHYR_AGENT_JWT_ISSUER";
  const audienceEnv = "ZEPHYR_AGENT_JWT_AUDIENCE";
