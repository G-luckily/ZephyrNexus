...
import { models as codexFallbackModels } from "@zephyr-nexus/adapter-codex-local";
import { models as cursorFallbackModels } from "@zephyr-nexus/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@zephyr-nexus/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.ZEPHYR_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.ZEPHYR_OPENCODE_COMMAND = "__paperclip_missing_opencode_command__";
