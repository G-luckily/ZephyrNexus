...
Office dispatch (optional):
- officeDispatchEnabled (boolean, optional): run office_dispatch.sh locally instead of gateway calls (default true)
- officeDispatchScriptPath (string, optional): path to office_dispatch.sh. If unset, adapter checks env OPENCLAW_OFFICE_DISPATCH_SCRIPT, then $HOME/projects/openclaw-workspace/scripts/office_dispatch.sh.
- officeDispatchUseOpenclaw (boolean, optional): tell office dispatch to use OpenClaw when supported (default true)
