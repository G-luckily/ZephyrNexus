...
export const COST_TIERS = ["standard", "high"] as const;
...
// Execution workbench state for frontend and orchestration telemetry.
...
export const CORE_EXECUTION_AGENT_NAMES = [
  "director_agent",
  "workflow_scheduler_agent",
  "state_observer_agent",
  "web_research_agent",
  "browser_execution_agent",
  "local_knowledge_agent",
  "fact_validation_agent",
  "content_generation_agent",
  "delivery_archive_agent",
] as const;
export type CoreExecutionAgentName = (typeof CORE_EXECUTION_AGENT_NAMES)[number];

export const SPECIALIST_AGENT_NAMES = [
  "job_strategy_agent",
  "resume_optimization_agent",
  "research_support_agent",
  "project_advancement_agent",
  "ui_product_experience_agent",
] as const;
export type SpecialistAgentName = (typeof SPECIALIST_AGENT_NAMES)[number];

export const EXECUTION_SKILLS = [
  "task-decomposition",
  "task-routing",
  "retry-policy",
  "human-checkpoint",
...
export type ExecutionSkillName = (typeof EXECUTION_SKILLS)[number];

export const EXECUTION_WORKFLOWS = [
  "online_research_workflow",
  "browser_execution_workflow",
  "hybrid_material_production_workflow",
] as const;
export type ExecutionWorkflowName = (typeof EXECUTION_WORKFLOWS)[number];

export const EXECUTION_ORG_LAYERS = [
  "control_hub",
  "capability_center",
  "specialist_team",
] as const;
export type ExecutionOrgLayer = (typeof EXECUTION_ORG_LAYERS)[number];
