...
export function IssueDetail() {
  ...
  const { data: budgetSummary, isLoading: isBudgetLoading } = useQuery({
    queryKey: [...queryKeys.issues.detail(issueId!), "budget"],
    queryFn: () => issuesApi.budgetSummary(selectedCompanyId!, issueId!),
    ...
    <div className="max-w-2xl space-y-6">
      ...
      {budgetSummary && (
        <BudgetSummaryCard
          ...
          recentEvents={budgetSummary.recentEvents}
      ...
      {budgetSummary && budgetSummary.blockedRuns && budgetSummary.blockedRuns.length > 0 && (
