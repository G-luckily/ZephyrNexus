    ...
    <div className="space-y-10 max-w-4xl">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Every component, style, and pattern used across Zephyr Nexus.
        </p>
      </div>
      ...
      <Section title="Component Coverage">
        <p className="text-sm text-muted-foreground">
          This page should be updated when new UI primitives or app-level
          patterns ship.
        </p>
      ...
      <Section title="Status System">
        ...
        <SubSection title="Agent status dots">
          <div className="flex items-center gap-4 flex-wrap">
            {(
              ["running", "active", "paused", "error", "archived"] as const
            ).map((label) => (
              <div key={label} className="flex items-center gap-2">
                <span className="relative flex h-2.5 w-2.5">
                  <span
                    className={`inline-flex h-full w-full rounded-full ${
                      agentStatusDot[label] ?? agentStatusDotDefault
                    }`}
                  />
                </span>
                <span className="text-xs text-muted-foreground">{label}</span>
          ...
          <SheetContent side="right">
            ...
            <div className="space-y-4 px-4">
              <div className="space-y-1">
                ...
                <Input
                  id="sheet-title"
                  defaultValue="Improve onboarding docs"
                />
              </div>
              <div className="space-y-1">
        ...
        <Dialog>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                This is a sample dialog showing the standard layout with header,
                content, and footer.
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-3">
        ...
        <div className="space-y-3 max-w-2xl">
          ...
          <div className="space-y-3">
            <div className="rounded-md border border-border p-3">
              ...
              <p className="text-sm">
                Started working on the authentication module. Will need API keys
                configured.
              </p>
            </div>
            <div className="rounded-md border border-border p-3">
