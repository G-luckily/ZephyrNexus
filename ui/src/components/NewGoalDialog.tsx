...
import { GOAL_STATUSES, GOAL_LEVELS } from "@zephyr-nexus/shared";
  ...
  return (
    ...
    >
      <DialogContent
        ...
        className={cn("glass-panel p-0 gap-0 border-border/80 shadow-[0_24px_48px_rgba(0,0,0,0.12)] overflow-hidden", expanded ? "sm:max-w-2xl" : "sm:max-w-lg")}
