...
export function EntityRow({
  ...
  const classes = cn(
    "flex items-center gap-3 px-4 py-2 text-sm border-b border-border last:border-b-0 transition-all",
    isClickable && "cursor-pointer hover:bg-accent/50 hover-lift",
