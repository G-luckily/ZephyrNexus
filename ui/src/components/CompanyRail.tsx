...
import type { Company } from "@zephyr-nexus/shared";
...
export function CompanyRail() {
  ...
  return (
    <div className="relative flex h-full w-[72px] shrink-0 flex-col items-center border-r border-sidebar-border bg-sidebar">
      ...
      {/* Company list */}
      <div className="relative z-[1] flex flex-1 w-full flex-col items-center gap-2 overflow-y-auto overflow-x-hidden py-3 scrollbar-none">
        <DndContext
          sensors={sensors}
      ...
      <div className="relative z-[1] pb-2 text-[9px] font-mono uppercase tracking-[0.14em] text-muted-foreground">
        {orderedCompanies.length} Co
      </div>
    </div>
  );
}
