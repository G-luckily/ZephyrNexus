/* global React */
// Lightweight icon set — line icons, 1.5px stroke, matches the calm aesthetic.
// Use as <Ic name="wind" /> ; size controlled by font-size or width style.

const Ic = ({ name, size = 14, stroke = 1.5, ...rest }) => {
  const common = {
    width: size,
    height: size,
    viewBox: "0 0 24 24",
