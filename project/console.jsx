/* global React, Ic */
// Zephyr Nexus — Console / Dashboard mock
// Self-contained: KPI strip, workflow viz, runtime log, budget guard, adapter health, task queue.

const { useState, useMemo, useEffect } = React;

/* ---------------- Sparklines ---------------- */
const Spark = ({ data, color = "var(--mint-300)", w = 120, h = 26 }) => {
...
window.BudgetGuard = BudgetGuard;
