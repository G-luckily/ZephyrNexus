/* global React, ReactDOM, Ic, Hero, Audit, IA, Tokens, ConsoleSection, WorkflowCloseup, RuntimeCloseup, MetricCards, Responsive, ComponentLibrary, Handoff, Foot, useTweaks, TweaksPanel, TweakSection, TweakRadio, TweakColor, TweakToggle */
...
const App = () => {
  ...
  // Density tweak — adjust base font-size and section padding via root vars
  useEffect(() => {
